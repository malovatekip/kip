            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 13 }}>
              ...
              <div>
                ...
                <div style={{ position: 'relative' }}>
                  ...
                  <button type="button" onClick={() => setShow(!show)} style={{ position: 'absolute', right: 14, top: '50%', transform: 'translateY(-50%)', background: 'none', border: 'none', color: 'var(--faint)', cursor: 'pointer' }}>
              ...
              {/* Terms checkbox */}
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: 10, padding: '12px 14px', background: 'var(--input-bg)', border: `1px solid ${agreed ? 'rgba(43,127,255,0.35)' : 'var(--border)'}`, borderRadius: 10, transition: 'border-color 0.2s ease' }}>
                <button
                  type="button"
                ...
                <p style={{ fontSize: 12, color: 'var(--muted)', lineHeight: 1.6, margin: 0 }}>
                  I have read and agree to KIP's{' '}
                  <Link to="/legal/terms" target="_blank" style={{ color: 'var(--blue-bright)', fontWeight: 600, textDecoration: 'none' }}>
                    Terms of Use
                  </Link>
                  {' '}and{' '}
                  <Link to="/legal/privacy" target="_blank" style={{ color: 'var(--blue-bright)', fontWeight: 600, textDecoration: 'none' }}>
                    Privacy Policy
                  </Link>
                  . I understand that KIP's AI responses are informational only and do not constitute professional financial or legal advice.
                </p>
              </div>
