...
export default function LoginPage() {
  ...
  const handleSubmit = async e => {
    ...
    try {
      ...
      toast.success(`Welcome back, ${(data.user.full_name || 'there').split(' ')[0]}!`)
          ...
          <div className="glass-panel" style={{ padding: '36px 32px' }}>
            ...
            <div style={{ textAlign: 'center', marginBottom: 26 }}>
              <div style={{ position: 'relative', display: 'inline-block', marginBottom: 12 }}>
                <div style={{ position: 'absolute', inset: -10, borderRadius: '50%', background: 'radial-gradient(circle,rgba(43,127,255,0.25) 0%,transparent 70%)', filter: 'blur(12px)' }} />
              ...
              <div style={{ fontFamily: 'Syne', fontWeight: 800, fontSize: 18, letterSpacing: '0.12em', color: 'var(--text)' }}>KIP</div>
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
              <div>
                ...
                <input type="email" required autoComplete="email" placeholder="you@example.com"
                  className="kip-input" value={email} onChange={e => setEmail(e.target.value)} />
              </div>
              <div>
                ...
                <div style={{ position: 'relative' }}>
                  <input type={show ? 'text' : 'password'} required autoComplete="current-password"
                    placeholder="Your password" className="kip-input" style={{ paddingRight: 44 }}
              ...
              <button type="submit" disabled={loading} className="kip-btn kip-btn-primary"
