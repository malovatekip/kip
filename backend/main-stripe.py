...
try: from app.models import subscription_models
except ImportError: pass
...
from app.routes import flutterwave_routes

Base.metadata.create_all(bind=engine)

app = FastAPI(title="Kwacha Intelligence Platform — KIP API", version="5.0.0")
...
app.include_router(flutterwave_routes.router, prefix="/api/flutterwave",   tags=["Flutterwave"])

@app.get("/")
def root():
    return {"platform": "KIP", "version": "5.0.0", "status": "operational"}
